...
<?
   ...
   if(!$telephone_number){
    ...
    //get customer reservation information 
    $sql2 = "select distinct datetime, D.name, style_menu, location from reservation R, designer D, customer C where C.name='$name'and cid=C.id and did=D.id" ;
